...
const PrintableBill: React.FC<PrintableBillProps> = ({
  ...
  amountPaid = 0,
  balance = 0,
  termsAndConditions = 'All disputes are subject to Prayagraj jurisdiction only',
  ...
  <img
    src="/ekdant_logo-black.png"
    alt="Ekdant Dental Logo"
    className="h-16 w-16 mr-3 logo-print"
  />

  <h1 className="text-4xl font-bold text-black tracking-wide">
    EKDANT
    <span className="ml-2 font-semibold tracking-[0.2em] text-[18px] uppercase">
      Dental Clinic
    </span>
  </h1>
</div>
            <p className="text-xs text-gray-700">
            Andawa Tiraha, Sahson Road,
beside Bikaner Mishthan Bhandar, Andawa,
Jhusi, Prayagraj – 211019 
            </p>
            <p className="text-xs text-gray-700 mt-1">Mobile: 9415252552</p>
          </div>
