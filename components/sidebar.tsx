          ...
          {isExpanded ? (
            <div className="flex items-center gap-3 fade-slide-in">
              <div className="w-14 h-14 rounded-lg flex items-center justify-center shadow-lg p-2">
                <img src="/ekdant_logo-white.png" alt="Logo" className="w-full h-full object-contain" />
              </div>
  <div className="flex flex-col justify-center">
  <span className="text-white text-2xl font-extrabold tracking-[0.12em] leading-none">
    EKDANT
  </span>

  <span className="text-gray-300 text-[11px] tracking-[0.45em] uppercase mt-1">
    Dental Clinic
  </span>
</div>
            </div>
