    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black items-center justify-center">
        <div className="px-12 max-w-lg text-center">
          ...
          <h1 className="text-4xl font-bold text-white mb-6">Ekdant Dental Clinic</h1>
          <p className="text-gray-300 text-lg leading-relaxed mb-8">
            Welcome to the Ekdant Dental Clinic administration portal. Manage appointments, patient records, and clinic operations with ease.
          </p>
